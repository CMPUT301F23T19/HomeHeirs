...
//
//        onView(withId(R.id.startDateLabel)).perform(click());
//        onData(allOf(is(instanceOf(Date.class)), is( "Jan-01-2003" ))).perform(click());
//
//
//        onView(withId(R.id.endDateLabel)).perform(click());
//        onData(allOf(is(instanceOf(Date.class)), is( "Aug-01-2023" ))).perform(click());
//
